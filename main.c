...
/* Configure the peripherals common clocks */
  ...
  uint32_t txData[100];
  GenerateSinePositionData(txData, 100);
  ...
  while (1)
  {
    /* USER CODE END WHILE */
	 ...
	 SendData_SAI(txData, 100);

	  /*HAL_SAI_Transmit(&hsai_BlockA1, &txData[0], 1, HAL_MAX_DELAY);
	  HAL_SAI_Transmit(&hsai_BlockA1, &txData[1], 1, HAL_MAX_DELAY);
	  HAL_SAI_Transmit(&hsai_BlockA1, &txData[2], 1, HAL_MAX_DELAY);
	  HAL_SAI_Transmit(&hsai_BlockA1, &txData[3], 1, HAL_MAX_DELAY);*/
